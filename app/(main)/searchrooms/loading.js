...
export default function Loading() {
  ...
  return (
    <div className="mt-10">
      <div className="relative flex justify-center items-center md:shrink-0 w-full">
        <div className="relative flex justify-center items-center md:shrink-0">
          <Skeleton
            className="
          grid grid-cols-1 md:grid-cols-12
          gap-6 container w-[90vw] md:w-[86vw] lg:w-[90vw] xl:w-[80vw] 2xl:w-[68vw] p-6 z-20"
          >
      ...
      <div className="w-[90vw] md:w-[90vw] lg:w-[90vw] xl:w-[80vw] 2xl:w-[70vw] mx-auto grid grid-cols-1 lg:grid-cols-12 mt-10">
        ...
        <div className="col-span-9 space-y-4">
          {loading.map((_, index) => (
            <div
              key={index}
              className="w-full h-auto grid grid-cols-6 md:grid-cols-9 gap-1 md:gap-6 space-x-2 bg-white p-2 shadow-lg rounded-sm"
            >
